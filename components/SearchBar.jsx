  ...
  return (
    <>
      <div className='flex-1 flexCenter dark:bg-nft-black-1 bg-white border dark:border-nft-black-2 border-nft-gray-2 px-4 py-3 rounded-md'>
        ...
        />
        <input type='text' placeholder='Search Projects' className='dark:bg-nft-black-1 bg-white mx-4 w-full dark:text-white text-nft-black-1 outline-none font-normal text-sm md:text-xs' value={debouncedSearch} onChange={(e) => setDebouncedSearch(e.target.value)} />
      </div>
